  ...
  reader.onload = function(e) {
    try {
      ...
      filas.forEach(fila => {
        ...
        // ID_Proveedor: comparación aparte (no en mapCampos) porque el valor "viejo" real de un
        // producto no migrado todavía vive en el campo legado `prov` (un solo id) — comparar
        // directo contra `prodExistente.provs` marcaría diff en CADA importación para cualquier
        // producto que nunca se haya vuelto a guardar desde el cambio a múltiples proveedores.
        // _provsDeProducto() ya resuelve esa compatibilidad (ver inventario.js). Se ordena antes
        // de comparar para que el mismo conjunto en distinto orden no cuente como cambio.
