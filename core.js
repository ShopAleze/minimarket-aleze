...
const FIREBASE_USERS = {
  'Shop Aleze':     'shopaleze@gmail.com',     // admin
  'Shop Aleze I':   'sharote1212@gmail.com',   // vendedor 1 (Shessira)
  'Shop Aleze II':  'joselezama.rom@gmail.com' // vendedor 2 (José Luis)
};
...
document.addEventListener('DOMContentLoaded', async function() {
  if (window.__bloqueadoPruebas) { console.log('🚧 Entorno de pruebas: acceso no desbloqueado, inicialización detenida.'); return; }
  const hoy = today();
